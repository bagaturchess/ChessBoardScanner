...
public class ScannerLoadExtractor {
	...
	public static void main(String[] args) {
		...
		try {
			...
			JarsManager jarsManager = new JarsManager("./../BoardScanner/libs/dl4j-1.0.0-beta3-short", "./libs/dl4j-1.0.0-beta3-load-shrinked.jar");
