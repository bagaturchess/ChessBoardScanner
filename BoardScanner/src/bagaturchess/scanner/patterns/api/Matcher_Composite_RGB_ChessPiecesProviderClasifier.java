...
public class Matcher_Composite_RGB_ChessPiecesProviderClasifier extends Matcher_Composite_RGB {
	...
	public Matcher_Composite_RGB_ChessPiecesProviderClasifier(InputStream piecesProviderClassifierNet, int imageSize, List<String> _netsNames, List<InputStream> _netsStreams, Map<String, Matcher_Base> _matchers) throws ClassNotFoundException, IOException {
